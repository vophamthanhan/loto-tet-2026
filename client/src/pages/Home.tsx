...
export default function Home() {
  ...
  return (
    <div 
      ...
      style={{
        backgroundImage: `url(${import.meta.env.BASE_URL}images/background-red.jpg)`,
    ...
    >
      ...
      <img 
        src={`${import.meta.env.BASE_URL}images/chua-cau.png`} 
        alt="Chùa Cầu Hội An" 
      ...
      <img 
        src={`${import.meta.env.BASE_URL}images/cau-rong.png`} 
      ...
      {/* Decorative lanterns */}
      <img 
        src={`${import.meta.env.BASE_URL}images/longden.png`} 
        alt="Đèn lồng" 
      ...
      <div className="relative z-20 h-full flex flex-col px-3 py-2">
        ...
        <header className="flex items-center justify-between gap-2">
          ...
          <img 
            src={`${import.meta.env.BASE_URL}images/chu.png`} 
            alt="Year End Party" 
